...
struct tcp_sock* _tcp_sock();
struct tcp_sock* get_tcp_sock(int sockfd);




int tcp_v4_connect_init(struct tcp_sock *sock, const struct sockaddr *addr, socklen_t addrlen);
...
//void tcp_output(struct tcp_sock *sock, struct tcphdr *hdr);
